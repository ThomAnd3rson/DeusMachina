...
contract DeusMachina is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6500000000 * 10**9;
                                    
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Deus Machina";
    string private _symbol = "DMACH";
    ...
    address public marketingWallet = 0xC5a88240D952303351D1e5051B5DFC6341aB3C41;
    address public devWallet = 0x61B2483a3c7596DEF409AB2D3ba1D3aC325ba1DD;
   ...
   function takeDev(address sender, uint256 tTransferAmount, uint256 rTransferAmount, uint256 tAmount) private
    returns (uint256, uint256)
    {
        if(_devFee==0) {  return(tTransferAmount, rTransferAmount); }
        ...
        _rOwned[devWallet] = _rOwned[devWallet].add(rdev);
    ...
    function prepareFoePresale() external onlyOwner() {
       _taxFee = 0;
       _previousTaxFee = 0;
       _liquidityFee = 0;
